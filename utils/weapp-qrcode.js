...
(function () {
  ...
  QRCode.prototype.makeImage = function () {
    ...
    for (var row = 0; row < nCount; row++) {
      for (var col = 0; col < nCount; col++) {
        ...
        var nLeft = _htOption.padding
          ? col * nWidth + _htOption.padding
          : col * nWidth;
        var nTop = _htOption.padding
          ? row * nHeight + _htOption.padding
          : row * nHeight;
        _oContext.setStrokeStyle(
          bIsDark ? _htOption.colorDark : _htOption.colorLight
        );
        // _oContext.setStrokeStyle('red')
        _oContext.setLineWidth(1);
        _oContext.setFillStyle(
          bIsDark ? _htOption.colorDark : _htOption.colorLight
        );
  ...
  QRCode.prototype.exportImage = function (callback) {
    if (
      ...
      typeof this._htOption.callback === "function"
    ) {
